...
static void    DrvCanInit   (CO_IF *co_if);
static void    DrvCanEnable (CO_IF *co_if, uint32_t baudrate);
static int16_t DrvCanSend   (CO_IF *co_if, CO_IF_FRM *frm);
static int16_t DrvCanRead   (CO_IF *co_if, CO_IF_FRM *frm);
static void    DrvCanReset  (CO_IF *co_if);
static void    DrvCanClose  (CO_IF *co_if);
